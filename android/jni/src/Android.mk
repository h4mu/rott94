...
LOCAL_CFLAGS += -g -ggdb -O0 -DUSE_SDL=1 -DPLATFORM_UNIX=1 -DS_IREAD=S_IRUSR -DS_IWRITE=S_IWUSR -DS_IEXEC=S_IXUSR
LOCAL_CFLAGS += -DSHAREWARE=$(SHAREWARE)
LOCAL_CFLAGS += -DSUPERROTT=$(SUPERROTT)
LOCAL_CFLAGS += -DSITELICENSE=$(SITELICENSE)
